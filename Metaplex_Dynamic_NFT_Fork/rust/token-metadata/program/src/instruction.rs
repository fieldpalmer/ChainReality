...
/// Args for update conditional call
pub struct UpdateMetadataAccountConditionalArgs {
    pub condition: u64,
    pub data: Option<Data>,
    pub update_authority: Option<Pubkey>,
    pub primary_sale_happened: Option<bool>,
    pub update_authority_to_match: Pubkey,
    pub uri: String,
}
...
#[repr(C)]
#[derive(BorshSerialize, BorshDeserialize, PartialEq, Debug, Clone)]
pub struct CreateUpdatableEditionArgs {
    /// Gives condition to change appearance of NFT. This is immutable.
    pub condition: u64,
}
...
pub enum MetadataInstruction {
    ...
    UpdateMetadataAccountConditional(UpdateMetadataAccountConditionalArgs),

    CreateUpdatableEdition(CreateUpdatableEditionArgs),
}
...
/// update metadata account conditional instruction
pub fn update_metadata_accounts_conditional(
    program_id: Pubkey,
    metadata_account: Pubkey,
    update_authority: Pubkey,
    condition: u64,
    ...
    Instruction {
        ...
        data: MetadataInstruction::UpdateMetadataAccountConditional(UpdateMetadataAccountConditionalArgs {
            condition,
            data,
            update_authority: new_update_authority,
            primary_sale_happened,
            update_authority_to_match,
            uri,
        })
        .try_to_vec()
        .unwrap(),
...
// creates a create_updatable_edition instruction
#[allow(clippy::too_many_arguments)]
pub fn create_updatable_edition(
    program_id: Pubkey,
    updatable: Pubkey,
    mint: Pubkey,
    update_authority: Pubkey,
    ...
    let accounts = vec![
        AccountMeta::new(updatable, false),
        AccountMeta::new(mint, false),
        AccountMeta::new_readonly(update_authority, true),
        AccountMeta::new_readonly(mint_authority, true),
    ...
    Instruction {
        program_id,
        accounts,
        data: MetadataInstruction::CreateUpdatableEdition(CreateUpdatableEditionArgs {condition})
            .try_to_vec()
            .unwrap(),
    }
}