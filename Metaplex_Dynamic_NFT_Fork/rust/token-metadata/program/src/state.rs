...
pub const UPDATABLE: &str = "updatable";
...
impl UpdatableEditionV1 {
    pub fn from_account_info(a: &AccountInfo) -> Result<UpdatableEditionV1, ProgramError> {
        let ue: UpdatableEditionV1 =
            try_from_slice_checked(&a.data.borrow_mut(), Key::UpdatableEditionV1,MAX_MASTER_EDITION_LEN)?;
