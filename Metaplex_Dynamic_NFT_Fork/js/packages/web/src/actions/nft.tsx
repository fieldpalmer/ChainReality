...
export const mintNFT = async (
  ...
  if (metadataFile?.transactionId && wallet.publicKey) {
    ...
    // In this instruction, update authority will be removed from the main mint and given to updatable PDA
    
    console.log("Create Updatable Edition");
    let condition=1;

    const updateInstructions1: TransactionInstruction[] = [];
    const updateSigners1: Keypair[] = [];

    await createUpdatableEdition(
      condition,
      mintKey,
      payerPublicKey,
      payerPublicKey,
    ...
    console.log({updateInstructions1},{updateSigners1});
    ...
    const updateInstructions2: TransactionInstruction[] = [];
    const updateSigners2: Keypair[] = [];
    ...
    console.log("Update Update Authority in Metadata");

    const updateInstructions3: TransactionInstruction[] = [];
    const updateSigners3: Keypair[] = [];

    const updateAuthorityNew: StringPublicKey = await getUpdatableEdition(mintKey);
