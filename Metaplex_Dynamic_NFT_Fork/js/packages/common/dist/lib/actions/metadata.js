...
exports.getEditionMarkPda = exports.deprecatedGetReservationList = exports.getMetadata = exports.getUpdatableEdition = exports.getEdition = exports.convertMasterEditionV1ToV2 = exports.deprecatedMintPrintingTokens = exports.signMetadata = exports.deprecatedCreateReservationList = exports.updatePrimarySaleHappenedViaToken = exports.mintNewEditionFromMasterEditionViaToken = exports.deprecatedMintNewEditionFromMasterEditionViaPrintingToken = exports.createUpdatableEdition = exports.createMasterEdition = exports.createMetadata = exports.updateMetadataConditional = exports.updateMetadata = exports.decodeMasterEdition = exports.decodeEdition = exports.decodeEditionMarker = exports.decodeMetadata = exports.METADATA_SCHEMA = exports.Metadata = exports.Data = exports.Creator = exports.Edition = exports.EditionMarker = exports.UpdatableEditionV1 = exports.MasterEditionV2 = exports.MasterEditionV1 = exports.MetadataCategory = exports.MetadataKey = exports.EDITION_MARKER_BIT_SIZE = exports.MAX_EDITION_LEN = exports.MAX_METADATA_LEN = exports.MAX_CREATOR_LEN = exports.MAX_CREATOR_LIMIT = exports.MAX_URI_LENGTH = exports.MAX_SYMBOL_LENGTH = exports.MAX_NAME_LENGTH = exports.UPDATABLE = exports.RESERVATION = exports.EDITION = exports.METADATA_PREFIX = void 0;
...
(function (MetadataKey) {
    ...
    MetadataKey[MetadataKey["UpdatableEditionV1"] = 8] = "UpdatableEditionV1";
...
(function (MetadataCategory) {
    ...
    MetadataCategory["Script"] = "script";
...
class UpdatableEditionV1 {
    constructor(args) {
        this.key = MetadataKey.UpdatableEditionV1;
        this.condition = args.condition;
    }
}
exports.UpdatableEditionV1 = UpdatableEditionV1;
class EditionMarker {
    constructor(args) {
...
class UpdateMetadataConditionalArgs {
    constructor(args) {
        this.instruction = 15;
        this.condition = args.condition;
        this.data = args.data ? args.data : null;
        this.updateAuthority = args.updateAuthority ? args.updateAuthority : null;
        this.primarySaleHappened = args.primarySaleHappened;
        this.updateAuthoritytomatch = args.updateAuthoritytomatch;
        this.uri = args.uri;
    }
}
...
class CreateUpdatableEditionArgs {
    constructor(args) {
        this.instruction = 16;
        this.condition = args.condition;
    }
    ...
    [
        UpdateMetadataConditionalArgs,
        {
            ...
            fields: [
                ...
                ['updateAuthority', { kind: 'option', type: 'pubkeyAsString' }],
                ['primarySaleHappened', { kind: 'option', type: 'u8' }],
                ['updateAuthoritytomatch', 'pubkeyAsString'],
                ['uri', 'string'],
            ],
        },
    ],
...
async function updateMetadataConditional(condition, data, newUpdateAuthority, primarySaleHappened, mintKey, updateAuthority, updateAuthoritytomatch, instructions, uri, metadataAccount) {
    const metadataProgramId = programIds_1.programIds().metadata;
    metadataAccount =
        metadataAccount ||
            (await utils_1.findProgramAddress([
    ...
    const value = new UpdateMetadataConditionalArgs({
        condition,
        data,
        updateAuthority: !newUpdateAuthority ? undefined : newUpdateAuthority,
        primarySaleHappened: primarySaleHappened === null || primarySaleHappened === undefined
...
exports.updateMetadataConditional = updateMetadataConditional;
...
async function createUpdatableEdition(condition, mintKey, updateAuthorityKey, mintAuthorityKey, payer, instructions) {
    const metadataProgramId = programIds_1.programIds().metadata;
    const metadataAccount = (await utils_1.findProgramAddress([
        Buffer.from(exports.METADATA_PREFIX),
        utils_1.toPublicKey(metadataProgramId).toBuffer(),
    ...
    const updatableAccount = (await utils_1.findProgramAddress([
        Buffer.from(exports.METADATA_PREFIX),
        utils_1.toPublicKey(metadataProgramId).toBuffer(),
        utils_1.toPublicKey(mintKey).toBuffer(),
        Buffer.from(exports.UPDATABLE),
    ], utils_1.toPublicKey(metadataProgramId)))[0];
    const value = new CreateUpdatableEditionArgs({ condition: condition });
    const data = Buffer.from(borsh_1.serialize(exports.METADATA_SCHEMA, value));
    const keys = [
        {
            pubkey: utils_1.toPublicKey(updatableAccount),
            isSigner: false,
            isWritable: true,
        },
        {
...
exports.createUpdatableEdition = createUpdatableEdition;
...
async function getUpdatableEdition(tokenMint) {
    const PROGRAM_IDS = programIds_1.programIds();
    return (await utils_1.findProgramAddress([
        Buffer.from(exports.METADATA_PREFIX),
        utils_1.toPublicKey(PROGRAM_IDS.metadata).toBuffer(),
...
exports.getUpdatableEdition = getUpdatableEdition;
