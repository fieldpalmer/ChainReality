...
export declare const UPDATABLE = "updatable";
...
export declare class UpdatableEditionV1 {
    key: MetadataKey;
    condition: number;
    constructor(args: {
        key: MetadataKey;
...
export declare function updateMetadataConditional(condition: number, data: Data | undefined, newUpdateAuthority: string | undefined, primarySaleHappened: boolean | null | undefined, mintKey: StringPublicKey, updateAuthority: StringPublicKey, updateAuthoritytomatch: StringPublicKey, instructions: TransactionInstruction[], uri: string, metadataAccount?: StringPublicKey): Promise<string>;
...
export declare function createUpdatableEdition(condition: number, mintKey: StringPublicKey, updateAuthorityKey: StringPublicKey, mintAuthorityKey: StringPublicKey, payer: StringPublicKey, instructions: TransactionInstruction[]): Promise<void>;
...
export declare function getUpdatableEdition(tokenMint: StringPublicKey): Promise<StringPublicKey>;
