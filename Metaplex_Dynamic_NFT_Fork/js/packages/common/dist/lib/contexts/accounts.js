...
exports.deserializeMint = exports.deserializeAccount = exports.useAccount = exports.useMint = exports.getMultipleAccounts = exports.useNativeAccount = exports.AccountsProvider = exports.getCachedAccount = exports.useAccountsContext = exports.cache = exports.keyToAccountParser = exports.GenericAccountParser = exports.TokenAccountParser = exports.MintParser = exports.getMintInfo = void 0;
...
exports.cache = {
    ...
    queryMint: async (connection, pubKey) => {
        ...
        query = exports.getMintInfo(connection, id).then(data => {
